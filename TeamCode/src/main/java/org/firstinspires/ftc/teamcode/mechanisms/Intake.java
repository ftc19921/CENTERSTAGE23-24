...
public class Intake {
    ...
    public void init(HardwareMap hardwareMap){
        ...
        intakeWrist = hardwareMap.get(Servo.class,"exServ1");
    }
    public void in(){intake.setPower(-1);}
    public void out(){intake.setPower(1);}
    public void stop(){intake.setPower(0);}
    public void deposit(){intakeWrist.setPosition(0.5);}
    public void vomit(){intakeWrist.setPosition(0.2);intake.setPower(1);};
